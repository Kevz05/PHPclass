...
// Variables
    ...
    //Subtract 2 years of seconds out of current to get days
    ...
    <div class="flex-box">
        ...
        <section class="main-content">
            <div class="transbox">
                <h2>Burning Man</h2>
                <div class="content">
                  1970 to Now: <?=$now?> secs <br> 1970 to Bruning Man Time: <?=$burningManTime?> secs <br>
                    Now to Burning Man: <?=$seconds?> secs <br> Years till Burning Man: <?=$Years?> <br>
                    Days until Burning Man: <?=$Days?> <br>
                    Hours until Burning Man: <?=$Hours?> <br>
                    Minutes until Burning Man: <?=$Minutes?> <br>
                    Seconds until Burning Man: <?=$seconds2?> <br>
                </div>
            </div>
        </section>
